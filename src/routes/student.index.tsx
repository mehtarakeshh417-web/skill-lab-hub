...
const TECHS = [
  ...
  { slug: "python", name: "Python", desc: "Modern programming language", icon: Code2, gradient: "from-sky-500 to-emerald-500" },
  ...
  { slug: "paint", name: "Paint", desc: "Digital drawing canvas", icon: Palette, gradient: "from-amber-500 to-amber-500" },
  { slug: "editor", name: "Word Editor", desc: "Word-processor practice", icon: FileText, gradient: "from-blue-500 to-emerald-500" },
