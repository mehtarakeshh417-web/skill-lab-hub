...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/95 backdrop-blur-2xl p-8 shadow-2xl shadow-slate-950/40 ring-1 ring-white/5 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
