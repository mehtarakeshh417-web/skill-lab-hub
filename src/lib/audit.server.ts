...
export const ACTION_CATALOG: Record<string, { label: string; type: string }> = {
  ...
  "password.change": { label: "Password changed by user", type: "Password change" },
  "password.reset.pin": { label: "Password recovered with Security PIN", type: "Password reset" },
  "password.reset.question": { label: "Password recovered with security question", type: "Password reset" },
  ...
  "admin.school.delete": { label: "School deleted", type: "Delete" },
